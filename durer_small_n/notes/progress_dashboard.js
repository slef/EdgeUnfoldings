...
function caseProgress(id,compact=false) {
  ...
  if (id==='t_octa') {
    ...
    body+=`<p><b>New route:</b> <a href="#octa_four_slits">try four positions of the fan opening</a>, then prove one works. <a href="#octa_switch">The overlap case analysis</a> reduces the sufficient target to 24 classes and proves one impossible, leaving <b>23 open</b>. This is an alternative to the two obligations above. The 3,000-shape pilot is numerical evidence only.</p><p class="progress-change">Earlier research hour: <b>no remaining universal gap closed</b>. The new apex-entry family rules out a stronger shortcut; joint-petal separation is still needed.</p>`;
