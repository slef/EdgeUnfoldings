...
one_pair_svg = (research / 'figures/prism-one-pair-comparison.svg').read_text()
figs['prism_one_pair'] = one_pair_svg[one_pair_svg.index('<svg'):].replace('<svg ', '<svg class="net" ', 1)
